        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">   
                    ...
                    <li>
                        <a href="#"><i class="iconfont icon-xueshengguanli"></i> <span class="nav-label">信息查询管理</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="QueryStudentSelf">查询个人信息</a></li>
                            <li><a class="J_menuItem" href="StudentSelectGrade">查询扣分信息</a></li>
                            <li><a class="J_menuItem" href="#">登记寻物启示</a></li>
                </ul>
                    </li>        
                    <li>
                        <a href="#"><i class="iconfont icon-guihuandingdan"></i> <span class="nav-label">故障申报维修</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="StudentAddRepairerInfo">故障维修申报</a></li>
                            <li><a class="J_menuItem" href="SeletRepf">查询故障信息</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="iconfont icon-tiyu1"></i> <span class="nav-label">水电费管理</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="#">充值水电费</a></li>
                            <li><a class="J_menuItem" href="#">查看余额</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a  href="Student_Login">退出系统</a></li>
                       </ul>
                    </li>
