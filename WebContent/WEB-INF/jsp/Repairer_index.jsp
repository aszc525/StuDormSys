                ...
                <ul class="nav" id="side-menu">   
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="QueryRepairerSelf">查询个人信息</a></li>
                </ul>
                    </li>        
                    <li>
                        <a href="#"><i class="iconfont icon-guihuandingdan"></i> <span class="nav-label">维修信息栏</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="RepfWorks">查询故障信息</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a  href="Repairer_Login">退出系统</a></li>
                       </ul>
                    </li>
                </ul>
            </div>
