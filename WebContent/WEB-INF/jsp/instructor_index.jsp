                ...
                <ul class="nav" id="side-menu">   
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="queryInstructorSelf">查询个人信息</a></li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="StudentSelectGrade">缺勤违纪打分信息</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="adminSeletVistor">来访信息记录</a></li> 
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a  href="instructorlogin">退出系统</a></li>
                       </ul>
                    </li>
