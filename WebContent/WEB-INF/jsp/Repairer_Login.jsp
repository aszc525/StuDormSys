			...
			<div class="inner-wrap">
				<div class="lg-zone">
					<div class="lg-box">
						...
						<form action="RepairerLogin" method="post">
							<div class="lg-username input-item clearfix">
								<i class="iconfont icon-yonghu"></i>
								<input  type="text" id="stu_id" name="repairer_id" placeholder="账号"/>
							</div>
							<div class="lg-password input-item clearfix">
								<i class="iconfont icon-mima"></i>
								<input type="password" id="stu_password" name="repairer_password" placeholder="密码"/>
							</div>	  
							 <div>
